    ...
    return (
            <Container>
                ...
                <Sidebar
                    ...
                    width='thin'
                >
                    <Menu.Item as={Link} to="/business-app2/dashboard" name='home' onClick={handleMenuItemClick}>
                        Home
                    </Menu.Item>
                    <Menu.Item as={Link} to="/business-app2/drivers" name='drivers' onClick={handleMenuItemClick}>
                        Drivers
                    </Menu.Item>
                    <Menu.Item as={Link} to="/business-app2/adddriver" name='add driver' onClick={handleMenuItemClick}>Add Driver</Menu.Item>
                    <Menu.Item as={Link} to="/business-app2/shipments" name='shipments' onClick={handleMenuItemClick}>Shipments</Menu.Item>
                    <Menu.Item as={Link} to="/business-app2/createshipment" name='create shipment' onClick={handleMenuItemClick}>Create Shipment</Menu.Item>
                    <Menu.Item as={Link} to="/business-app2/routeplanning" name='route planning' onClick={handleMenuItemClick}>Route Planning</Menu.Item>
                    <Menu.Item as={Link} to="/business-app2/reports" name='reports' onClick={handleMenuItemClick}>Reports</Menu.Item>
